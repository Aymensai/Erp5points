...
(function($) {
  ...
  function ensureVisible(li) {
    ...
    if (top < 0) {
      scroller.animate({ scrollTop: scroller.scrollTop() + top }, "fast");
    }
  }
  $items.find("> a").on("click", function() {
    var prev = $(this)
        .closest("ul.nav")
        .find("> li.nav-expanded"),
...
(function(theme, $) {
  ...
  var Skeleton = {
    ...
    setVars: function() {
      this.sidebars = {};
      this.sidebars.left = { $el: $(this.options.sidebars.left) };
      this.sidebars.right = {
    ...
    eventsContentMenu: function() {
      ...
      var open = function() {
        ...
        $window.trigger("inner-menu-toggle", { added: true, removed: false });
      ...
      var close = function(e) {
        ...
        $window.trigger("inner-menu-toggle", { added: false, removed: true });
      ...
      setTimeout(function() {
        if (shouldPrevent) {
          $body
            ...
            .css({ position: "fixed", top: $body.get(0).scrollTop * -1 });
        } else {
          $body
            .css({ position: "", top: "" })
...
(function(theme, $) {
  ...
  Mailbox.prototype = {
    ...
    buildFolder: function() {
      this.$wrapper
        .find(".mailbox-email-list .nano")
        .nanoScroller({ alwaysVisible: true, preventPageScrolling: true });
    },
    buildEmail: function() {
      this.buildComposer();
    },
    ...
    eventsCompose: function() {
      ...
      var adjustComposeSize = function() {
        ...
        $composer.css({ height: composerHeight });
      };
      var timer;
      $(window).on(
...
(function($) {
  ...
  var LockScreen = {
    ...
    show: function() {
      ...
      $.magnificPopup.open({
        items: { src: this.lockHTML, type: "inline" },
        modal: true,
    ...
    getUserInfo: function() {
      ...
      return { picture: picture, username: name, email: email };
    },
  ...
  $(function() {
    $(".panel")
      ...
      .on("click", ".panel-actions a.fa-times", function(e) {
        ...
        $panel = $(this).closest(".panel");
        if (
          !!($panel.parent("div").attr("class") || "").match(
            /col-(xs|sm|md|lg)/g
          ) &&
...
(function($) {
  ...
  var toggleClass = function($el) {
    ...
    $el.on("click.toggleClass", function(e) {
      ...
      if (!!eventName) {
        $window.trigger(eventName, { added: hasClass, removed: !hasClass });
      }
    });
...
(function(theme, $) {
  ...
  $.extend(theme, { PluginCodeMirror: PluginCodeMirror });
...
(function(theme, $) {
  ...
  $.extend(theme, { PluginColorPicker: PluginColorPicker });
...
(function(theme, $) {
  ...
  $.extend(theme, { PluginDatePicker: PluginDatePicker });
...
(function(theme, $) {
  ...
  $.extend(theme, { PluginIOS7Switch: PluginIOS7Switch });
...
(function(theme, $) {
  ...
  PluginMarkdownEditor.defaults = { iconlibrary: "fa" };
  ...
  $.extend(theme, { PluginMarkdownEditor: PluginMarkdownEditor });
...
(function(theme, $) {
  ...
  $.extend(theme, { PluginMaskedInput: PluginMaskedInput });
...
(function(theme, $) {
  ...
  $.extend(theme, { PluginMaxLength: PluginMaxLength });
...
(function(theme, $) {
  ...
  $.extend(theme, { PluginMultiSelect: PluginMultiSelect });
...
(function(theme, $) {
  ...
  $.extend(theme, { PluginSelect2: PluginSelect2 });
...
(function(theme, $) {
  ...
  $.extend(theme, { PluginSpinner: PluginSpinner });
...
(function(theme, $) {
  ...
  $.extend(theme, { PluginSummerNote: PluginSummerNote });
...
(function(theme, $) {
  ...
  $.extend(theme, { PluginTextAreaAutoSize: PluginTextAreaAutoSize });
...
(function(theme, $) {
  ...
  PluginTimePicker.defaults = { disableMousewheel: true };
  ...
  $.extend(theme, { PluginTimePicker: PluginTimePicker });
...
(function(theme, $) {
  ...
  GMapBuilder.defaults = {
    ...
    mapOptions: {
      center: { lat: -38.908133, lng: -13.692628 },
      panControl: true,
      zoom: 3
    }
  };
  GMapBuilder.prototype = {
      ...
      overviewcontrol: function(value) {
        ...
        if (value === "false") {
          ...
          options = {
            ...
            overviewMapControlOptions: { opened: value === "opened" }
          };
        }
        this.map.setOptions(options);
        return this;
      ...
      maptheme: function(value) {
        ...
        mapType =
          google.maps.MapTypeId[
            this.map.getMapTypeId() === "terrain" ? "TERRAIN" : "ROADMAP"
          ];
        options = {};
        json = this.$wrapper
          .find('[data-builder-field="maptheme"]')
          ...
          .data("json");
        if (!json) {
          options = { mapTypeId: mapType, styles: false };
        } else {
          options = { mapTypeId: mapType, styles: eval(json) };
        }
        this.map.setOptions(options);
      }
    },
    ...
    _onGeocodeResult: function(marker, response, status) {
      ...
      if (!response || status !== google.maps.GeocoderStatus.OK) {
        ...
        result = response[0];
        marker.lat =
          Math.round(result.geometry.location.lat() * 1000000) / 1000000;
        marker.lng =
          Math.round(result.geometry.location.lng() * 1000000) / 1000000;
        var opts = {
    ...
    preview: function() {
      ...
      customScript.text =
        "window.initialize = function() { " + this.generate() + " init(); }; ";
      iframe.body.appendChild(customScript);
      googleScript = iframe.createElement("script");
      googleScript.type = "text/javascript";
      googleScript.text =
        'function loadScript() { var script = document.createElement("script"); script.type = "text/javascript"; script.src = "http://maps.googleapis.com/maps/api/js?key=&sensor=&callback=initialize"; document.body.appendChild(script); } loadScript()';
      iframe.body.appendChild(googleScript);
    },
    getCode: function() {
      this.$getCodeModal.find(".modal-body pre").html(
        this.generate()
          .replace(/</g, "&lt;")
          .replace(/>/g, "&gt;")
      );
    ...
    generate: function() {
      ...
      var mapTypeControl =
        this.$wrapper
          .find('[data-builder-field="maptypecontrol"] option:selected')
          .val() !== "false";
      ...
      output = output
        ...
        .replace(
          /\{lat\}/,
          this.$wrapper.find('[data-builder-field][name="latitude"]').val()
        )
        .replace(
          /\{lng\}/,
          this.$wrapper.find('[data-builder-field][name="longitude"]').val()
        )
        .replace(
          /\{zoom\}/,
          this.$wrapper
            .find('[data-builder-field="zoomlevel"] option:selected')
            .val()
        )
        ...
        .replace(
          ...
          this.$wrapper
            .find('[data-builder-field="clicktozoomcontrol"] option:selected')
            .val() === "false"
        )
        ...
        .replace(
          /\{scaleControl\}/,
          this.$wrapper
            .find('[data-builder-field="scalecontrol"] option:selected')
            .val() !== "false"
        )
        .replace(
          /\{scrollwheel\}/,
          this.$wrapper
            .find('[data-builder-field="scrollwheelcontrol"] option:selected')
            .val() !== "false"
        )
        .replace(
          /\{panControl\}/,
          this.$wrapper
            .find('[data-builder-field="pancontrol"] option:selected')
            .val() !== "false"
        )
        .replace(
          /\{streetViewControl\}/,
          this.$wrapper
            .find('[data-builder-field="streetviewcontrol"] option:selected')
            .val() !== "false"
        )
        .replace(
          /\{draggable\}/,
          this.$wrapper
            .find('[data-builder-field="draggablecontrol"] option:selected')
            .val() !== "false"
        )
  ...
  $.extend(true, theme, { Maps: { GMapBuilder: GMapBuilder } });
...
(function(theme, $) {
  ...
  PluginChartCircular.prototype = {
    ...
    build: function() {
      ...
      shouldAnimate =
        ...
        typeof $.browser !== "undefined" && !$.browser.mobile;
  ...
  $.extend(true, theme, {
    Chart: { PluginChartCircular: PluginChartCircular }
  });
...
(function(theme, $) {
  ...
  PluginPortlet.prototype = {
    ...
    events: function($el) {
      ...
      $el
        .find(".panel-actions")
        .on("click", "a.fa-caret-up, a.fa-caret-down, a.fa-times", function(e) {
          setTimeout(function() {
            _self.saveState($el);
          }, 250);
        });
  ...
  $.extend(theme, { PluginPortlet: PluginPortlet });
...
(function(theme, $) {
  ...
  $.extend(theme, { PluginSlider: PluginSlider });
...
(function(theme, $) {
  ...
  $.extend(theme, { WidgetTodoList: WidgetTodoList });
...
(function(theme, $) {
  ...
  $.extend(theme, { WidgetToggleExpand: WidgetToggleExpand });
...
(function(theme, $) {
  ...
  PluginWordRotate.defaults = { delay: 2000 };
  PluginWordRotate.prototype = {
    ...
    build: function() {
      ...
      setInterval(function() {
        ...
        itemsWrapper.animate({ top: -currentTop + "px" }, 300, function() {
          currentItem++;
